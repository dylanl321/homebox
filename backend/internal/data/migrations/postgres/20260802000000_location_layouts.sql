...
CREATE TABLE IF NOT EXISTS "location_layouts" (
    ...
    "canvas_width" bigint NOT NULL DEFAULT 1000,
    "canvas_height" bigint NOT NULL DEFAULT 700,
...
CREATE TABLE IF NOT EXISTS "location_layout_elements" (
    ...
    "created_at" timestamptz NOT NULL,
    "updated_at" timestamptz NOT NULL,
    "kind" character varying NOT NULL CHECK ("kind" IN ('wall', 'location')),
    ...
    "entity_layout_placements" uuid NULL REFERENCES "entities" ("id") ON DELETE CASCADE,
