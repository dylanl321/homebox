            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/repo.LocationLayoutOut"
                        }
                    }
                }
            },
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/repo.LocationLayoutReplace"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "ent.EntityEdges": {
            ...
            "properties": {
                ...
                "layout_placements": {
                    "description": "LayoutPlacements holds the value of the layout_placements edge.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ent.LocationLayoutElement"
                    }
                },
                "location_layout": {
                    "description": "LocationLayout holds the value of the location_layout edge.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/ent.LocationLayout"
                        }
                    ]
                },
                "maintenance_entries": {
        ...
        "ent.LocationLayout": {
            ...
            "properties": {
                "canvas_height": {
                    "description": "CanvasHeight holds the value of the \"canvas_height\" field.",
                    "type": "integer"
                },
                "canvas_width": {
                    "description": "CanvasWidth holds the value of the \"canvas_width\" field.",
                    "type": "integer"
                },
                "created_at": {
                    "description": "CreatedAt holds the value of the \"created_at\" field.",
                ...
                "edges": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/ent.LocationLayoutEdges"
                        }
                    ]
                },
                "id": {
        ...
        "ent.LocationLayoutEdges": {
            "type": "object",
            "properties": {
                "elements": {
                    "description": "Elements holds the value of the elements edge.",
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/ent.LocationLayoutElement"
                    }
        ...
        "ent.LocationLayoutElement": {
            ...
            "properties": {
                ...
                "edges": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/ent.LocationLayoutElementEdges"
                        }
                    ]
                },
                "end_x": {
                    "description": "EndX holds the value of the \"end_x\" field.",
                    "type": "number"
                },
                "end_y": {
                    "description": "EndY holds the value of the \"end_y\" field.",
                    "type": "number"
                },
                "height": {
                ...
                "kind": {
                    ...
                    "allOf": [
                        {
                            "$ref": "#/definitions/locationlayoutelement.Kind"
                        }
                    ]
                },
                "rotation": {
                    "description": "Rotation holds the value of the \"rotation\" field.",
                    "type": "number"
                },
                "updated_at": {
                    "description": "UpdatedAt holds the value of the \"updated_at\" field.",
                ...
                "x": {
                    "description": "X holds the value of the \"x\" field.",
                    "type": "number"
                },
                "y": {
                    "description": "Y holds the value of the \"y\" field.",
                    "type": "number"
                },
                "z_order": {
                    "description": "ZOrder holds the value of the \"z_order\" field.",
                    "type": "integer"
                }
            }
        },
        "ent.LocationLayoutElementEdges": {
            "type": "object",
            "properties": {
                "layout": {
                    "description": "Layout holds the value of the layout edge.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/ent.LocationLayout"
                        }
                ...
                "target": {
                    "description": "Target holds the value of the target edge.",
                    "allOf": [
                        {
                            "$ref": "#/definitions/ent.Entity"
                        }
        ...
        "repo.LocationLayoutElementInput": {
            "type": "object",
            "properties": {
                "endX": {
                    "type": "number"
        ...
        "repo.LocationLayoutOut": {
            ...
            "properties": {
                ...
                "locations": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/repo.LocationLayoutPlacement"
                    }
                },
                "revision": {
                    "type": "integer"
                ...
                "walls": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/repo.LocationLayoutWall"
                    }
                }
            }
        },
        "repo.LocationLayoutPlacement": {
            "type": "object",
            "properties": {
                "height": {
                    "type": "number"
        ...
        "repo.LocationLayoutReplace": {
            "type": "object",
            "properties": {
                "elements": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/repo.LocationLayoutElementInput"
                    }
                },
                "expectedRevision": {
                    "type": "integer"
