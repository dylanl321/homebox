...
| HBOX_LABEL_MAKER_PRINT_COMMAND          |                                                                                                | legacy: shell command that prints a PNG. unused when direct Zebra print is enabled                                                                                                        |
| HBOX_LABEL_MAKER_DIRECT_PRINT           | true                                                                                           | send ZPL directly to the Zebra over TCP (no separate print-server process). uses `PRINTER_IP`:`PRINTER_PORT`                                                                              |
| HBOX_LABEL_MAKER_PRINT_SERVER_URL       |                                                                                                | optional HTTP bridge URL if Homebox cannot reach the printer (zebra-label-maker `/print`). leave empty for direct TCP                                                                     |
| HBOX_LABEL_MAKER_PRINTER_IP             | 10.0.1.161                                                                                     | Zebra printer IP                                                                                                                                                                          |
| HBOX_LABEL_MAKER_PRINTER_PORT           | 9100                                                                                           | Zebra raw TCP port                                                                                                                                                                        |
| HBOX_LABEL_MAKER_PRINT_DARKNESS         | 15                                                                                             | ZPL `~SD` darkness (same as zebra-label-maker settings)                                                                                                                                   |
| HBOX_LABEL_MAKER_PRINT_SPEED            | 4                                                                                              | ZPL `^PR` print speed                                                                                                                                                                     |
| HBOX_LABEL_MAKER_LABEL_SIZE             | 2x1                                                                                            | zebra-label-maker size preset: `1x1`, `2x1`, `2.25x1.25`, `3x2`, `4x2`, `4x6`                                                                                                            |
| HBOX_LABEL_MAKER_ORIENTATION            | portrait                                                                                       | `portrait` or `landscape` (landscape on `2x1` → 1″×2″)                                                                                                                                    |
| HBOX_LABEL_MAKER_PRINT_FONT_SIZE        | 30                                                                                             | ZPL font size in dots (zebra-label-maker medium = 30)                                                                                                                                     |
...
OPTIONS
  ...
  -h, --help                                                                                                                                                       display this help message
      ...
      --label-maker-print-darkness          <int>       (default: 15)
      --label-maker-print-server-url        <string>
      --label-maker-print-speed             <int>       (default: 4)
      --label-maker-printer-ip              <string>    (default: 10.0.1.161)
      --label-maker-printer-port            <int>       (default: 9100)
